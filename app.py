...
def main():
    ...
    researcher = Agent(
        ...
        backstory=(
            ...
            "If you do not find any relevant legal text, clearly state that the database does not contain information that answers the user's question."
    ...
    writer = Agent(
        ...
        backstory=(
            ...
            "If the researcher did not provide any legal articles, write a formal message stating that no legal basis was found to answer the question from the available sources."
        ),
        llm=llm,
        allow_delegation=False
    )
